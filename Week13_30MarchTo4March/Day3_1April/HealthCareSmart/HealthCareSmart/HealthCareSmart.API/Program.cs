...
builder.Services.AddDbContext<AppDbContext>(options =>
    options.UseSqlServer("Server=DESKTOP-ELLK6DL\\SQLEXPRESS;Database=HealthCareSmartDB;Trusted_Connection=True;TrustServerCertificate=True;"));
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowMVC",
        policy =>
        {
            policy.WithOrigins("https://localhost:7003", "http://localhost:5003") // your MVC ports
                  .AllowAnyMethod()
                  .AllowAnyHeader();
        });
});
...
*/
// Temporarily disable seeding to test startup
// SeedData(app);
app.Run();