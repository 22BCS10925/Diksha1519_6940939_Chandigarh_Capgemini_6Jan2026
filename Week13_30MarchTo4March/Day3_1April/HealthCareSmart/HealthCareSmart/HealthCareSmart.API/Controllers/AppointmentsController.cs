        ...
        public async Task<IActionResult> GetAll()
        {
            var appointments = await _context.Appointments
                ...
                .Select(a => new AppointmentDTO
                {
                    ...
                    Notes = a.Notes,
                    IsPaid = a.Billing != null ? a.Billing.IsPaid : false,
...
public async Task<IActionResult> Create([FromBody] CreateAppointmentDTO dto)
{
    ...
    _logger.LogInformation("Appointment + Billing created. AppointmentId: {Id}", appointment.Id);
...
public async Task<IActionResult> MarkAsPaid(int id)
{
    ...
    if (appointment.Billing == null)
        return BadRequest(new { message = "Billing not found" });

    if (appointment.Billing.IsPaid)
        return BadRequest(new { message = "Already paid" });

    // 🔥 Mark as paid
    appointment.Billing.IsPaid = true;
    appointment.Billing.PaidAt = DateTime.UtcNow;
