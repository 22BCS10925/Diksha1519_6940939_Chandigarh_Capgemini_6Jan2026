...
namespace ADODOTNETCORE
{
    internal class Program
    {
        static void Main(string[] args)
        {
            try
            {
                string connectionString ="Server=DESKTOP-ELLK6DL\\SQLEXPRESS;" +"Initial Catalog=EmployeeDB;" +"Integrated Security=True;" +"TrustServerCertificate=True;";
                // Get All Employees
        ...
        static void GetAllEmployees(string connectionString)
        {
            ...
            {
                SqlCommand command =
                    new SqlCommand("GetAllEmployee", connection);
